module.exports = Object.freeze({
  TOKEN: '1010365575:AAFzUkvMMNFeGzucqKVlB_xANMKBKZReQ_U', //required
  ARIA_SECRET: 'hellowtf', //change as per needs.
  ...
  GDRIVE_PARENT_DIR_ID:  '1-gz0rlfnCMuXTNOBPMxt_0v_3yCMmVaF', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboW$
  SUDO_USERS: [879820429],      // Telegram user IDs. These users can use the bot in any chat. required, get it using https://t.me/YourTGid_Bot
  AUTHORIZED_CHATS: [-1001195033932],   // Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
